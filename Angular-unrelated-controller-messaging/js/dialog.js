angular
        .module('modalTest',
                ['ui.bootstrap', 'dialogs.main', 'pascalprecht.translate'])
        .controller(
                'dialogServiceTest',
                function($scope, $rootScope, $timeout, $translate, dialogs) {
                  ...
                  $scope.launch = function(which) {
                    ...
                    case 'custom2':
                      var dlg = dialogs.create('/dialogs/custom2.html',
                              'customDialogCtrl2', $scope.custom, 'lg');
                      break;
                    }
                  }; // end launch
                ...
                function($scope, $modalInstance, data) {
                  ...
                  $scope.hitEnter = function(evt) {
                    if (angular.equals(evt.keyCode, 13)
                            && !(angular.equals($scope.user.name, null) || angular
                                    .equals($scope.user.name, '')))
                      $scope.save();
                  };
                })
        // end controller(customDialogCtrl)

        .controller('customDialogCtrl2',
                function($scope, $modalInstance, data) {
